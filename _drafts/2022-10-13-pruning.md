...
[oBERT paper](https://arxiv.org/pdf/2203.07259.pdf), [blog](https://neuralmagic.com/blog/obert/) GPU-Level Latency on CPUs with 10x Smaller Models
...
**Second-order Pruning prunes minimizing the approximation of loss change**, e.g., [M-FAC method](https://arxiv.org/pdf/2107.03356.pdf).
	oBERT extends **Second-order to Structured Pruning**, reusing Fisher Information Matrix approximation of the Hessian, speeds ups inversion with WSM inversion formula and block-wise approximation.
