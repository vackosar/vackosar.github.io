...
[oBERT paper](https://arxiv.org/pdf/2203.07259.pdf) from [Neural Magic](https://neuralmagic.com/blog/obert/) achieves **the same latency on 4-core CPU as on T4 GPU** with metrics within 1% difference and 10x smaller [BERT model](/ml/transformers-self-attention-mechanism-simplified).
...
### Neural Magic Engine CPU vs GPU Costs
...
**Predicting on 4-core CPU and saving approximately 2x to 4x costs** with more device availability in contrast to T4 GPU.
Results 4x savings on AWS Ohio, but that is optimistic. Conservatively I guess 2x.
- Instance name On-Demand hourly rate vCPU Memory Storage Network performance
- g4dn.xlarge (T4 GPU)	$0.526	4	16 GiB	125 GB NVMe SSD	Up to 25 Gigabit
